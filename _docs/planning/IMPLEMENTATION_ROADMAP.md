...
- **DP2** Inventory at `_docs/migration/INCORPORATION_INVENTORY.md`.
...
Per [INCORPORATION_INVENTORY.md §2.1](_docs/migration/INCORPORATION_INVENTORY.md):
...
- **DOCS (already exist or updated):** `README.md`, `_docs/reference/ARCHITECTURE.md`, `_docs/planning/IMPLEMENTATION_ROADMAP.md` (this file), `_docs/reference/SOURCE_PROVENANCE.md`, `_docs/reference/TOOLS.md`, `contracts/BCC.md`, `_docs/migration/INCORPORATION_INVENTORY.md`
...
**Status:** COMPLETE. Smoke test 10/10 PASS. Park Phase performed in degraded form (full Park Phase requires `journal_manager` from T2; closeout notes captured at `_docs/history/tranches/T1_CLOSEOUT_NOTES.md`).
...
- Source: [`_docs/history/tranches/T1_CLOSEOUT_NOTES.md`](_docs/history/tranches/T1_CLOSEOUT_NOTES.md)
...
- `_docs/history/tranches/T1_CLOSEOUT_NOTES.md` marked SUPERSEDED with banner pointing to the entry.
...
- Source: [`_docs/history/tranches/T2_PARK_NOTES.md`](_docs/history/tranches/T2_PARK_NOTES.md)
...
- new continuity docs: `_docs/continuity/WE_ARE_HERE_NOW.md`, `_docs/planning/NORTHSTARS.md`, `_docs/history/DEV_LOG.md`
- new tools: `text_file_writer`, `directory_scaffold`

**Evidence:**
- park notes: [`_docs/history/tranches/T4_PARK_NOTES.md`](_docs/history/tranches/T4_PARK_NOTES.md)
...
- canonical continuity docs: `_docs/continuity/WE_ARE_HERE_NOW.md`, `_docs/planning/NORTHSTARS.md`, `_docs/history/DEV_LOG.md`
...
**Evidence:**
- park notes: [`_docs/history/tranches/T5_PARK_NOTES.md`](_docs/history/tranches/T5_PARK_NOTES.md)
...
**Evidence:**
- park notes: [`_docs/history/tranches/T6_PARK_NOTES.md`](_docs/history/tranches/T6_PARK_NOTES.md)
...
**Evidence:**
- park notes: [`_docs/history/tranches/T7_PARK_NOTES.md`](_docs/history/tranches/T7_PARK_NOTES.md)
...
**Evidence:**
- park notes: [`_docs/history/tranches/T9_PARK_NOTES.md`](_docs/history/tranches/T9_PARK_NOTES.md)
...
- authoritative closeout metadata: [`_docs/history/tranches/T9_CLOSEOUT_METADATA.json`](_docs/history/tranches/T9_CLOSEOUT_METADATA.json)
...
**Scope:** Only the remaining trust/perf/expansion items that still matter after the vendability seal, plus the recentering required to evolve `.scaffold` into a chat-centered, project-bound sidecar without creating a second memory or authority layer. T10 is a post-baseline horizon, not a missing baseline tranche.
...
**Evidence:**
- park notes: [`_docs/history/tranches/T10_PARK_NOTES.md`](_docs/history/tranches/T10_PARK_NOTES.md)
- authoritative closeout metadata: [`_docs/history/tranches/T10_CLOSEOUT_METADATA.json`](_docs/history/tranches/T10_CLOSEOUT_METADATA.json)
- latest parked tranche metadata alias: [`_docs/continuity/LATEST_PARKED_TRANCHE.json`](_docs/continuity/LATEST_PARKED_TRANCHE.json)
...
### **Tranche 10.1 — Prototype Target Requirements Map + Chat-Centered Sidecar Alignment** — ✓ COMPLETE (2026-05-15)

**Status:** COMPLETE. This was a planning/doctrine tranche, not a chat implementation tranche.

**Evidence:**
- park notes: [`_docs/history/tranches/T10_1_PARK_NOTES.md`](_docs/history/tranches/T10_1_PARK_NOTES.md)
- park-notes blob hash: `afe9b35ca828a84b242e1c94b2366d51976a9e3da6a4b407567aec4ed5fa7d8a`
- tranche journal entry: `journal_18afc62d4ea1f43c_49c6368b`
- authoritative closeout metadata: [`_docs/history/tranches/T10_1_CLOSEOUT_METADATA.json`](_docs/history/tranches/T10_1_CLOSEOUT_METADATA.json)

**What landed:**
- `_docs/planning/TARGET_STATE.md` now locks the new target into project truth
- the target is now split into:
...
- backlog is reclassified honestly without silently erasing stale historical todos
- doctrine now explicitly states:
  - chat is the planned primary cockpit
  - Tk is the secondary operator surface
  - future chat actions must route through existing spine surfaces
- the first narrow implementation slice is now fixed as:
  - `T10.2 Chat Review Gate Surface`

**Non-goals maintained:**
- no chat workspace implementation
- no runtime API, tool, or schema expansion
- no second memory layer
- no second authority path
- no bypass around the sidecar spine
- no silent todo cleanup

### **Tranche 10.3 — Explicit Authority Registration Hardening** — ✓ COMPLETE (2026-05-18)

**Status:** COMPLETE. This was a narrow trust-surface hardening tranche.

**Evidence:**
- park notes: [`_docs/history/tranches/T10_3_PARK_NOTES.md`](_docs/history/tranches/T10_3_PARK_NOTES.md)
- tranche journal entry: `journal_18b0d0497cf99b24_08cbea29`
- authoritative closeout metadata: [`_docs/history/tranches/T10_3_CLOSEOUT_METADATA.json`](_docs/history/tranches/T10_3_CLOSEOUT_METADATA.json)

**What landed:**
- ordinary routed actors now materialize explicit authority rows when they first traverse the spine
- smoke proves a non-session actor can route work and receives a persisted authority row with recorded provenance
- continuity/status surfaces now treat `T10.3` as the latest parked tranche and move the next narrow candidate forward

**Non-goals maintained:**
- no second authority path
- no grant-model redesign
- no broad identity migration

**Next implementation candidate:** `T10.4 HARD_BLOCK and Mutation-Path Trust-Gate Completion`

---

### **Tranche 10.4 — HARD_BLOCK and Mutation-Path Trust-Gate Completion** — ✓ COMPLETE (2026-05-19)

**Status:** COMPLETE. This was a narrow trust-floor hardening tranche.

**Evidence:**
- park notes: [`_docs/history/tranches/T10_4_PARK_NOTES.md`](_docs/history/tranches/T10_4_PARK_NOTES.md)
- authoritative closeout metadata: [`_docs/history/tranches/T10_4_CLOSEOUT_METADATA.json`](_docs/history/tranches/T10_4_CLOSEOUT_METADATA.json)

**What landed:**
- project-targeted `text_file_writer` and `directory_scaffold` mutations now fail early at the contract gate with concrete reasons instead of depending on tool-local checks alone
- scaffold approvals now derive and enforce exact manifest `entry_paths`, so changed scaffold manifests stop matching prior grants
- `declare_tranche` now blocks when authoritative latest-closeout state and `WE_ARE_HERE_NOW.md` drift apart
- smoke proves the new hard-block paths, manifest-aware approval matching, and tranche-declaration drift blocking without regressing MCP review/park or installed-proof flows

**Non-goals maintained:**
- no derived BCC constraint-map work yet
...
- Chat-centered operator cockpit over the existing spine, starting with the Chat Review Gate Surface.
...
- No chat subsystem that creates a second memory layer, second authority path, or bypass around the sidecar spine.
...
- `_docs/migration/INCORPORATION_INVENTORY.md` exists and every reviewed precursor item has a decision tag. **Done.**
