...
| `builtin_contract.md` | 61 KB | **ADAPT sections** | Use defined sections (definitions, domains, phases, non-goals) as reference for our `contracts/builder_constraint_contract.md` evolution; we already updated the contract in Tranche 0. |
