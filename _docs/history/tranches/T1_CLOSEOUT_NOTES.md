...
9. **`detect_sidecar_root`** — walks up from any source file looking for either a directory named `.scaffold` *or* a directory containing `contracts/builder_constraint_contract.md`. Robust to where you invoke `python -m src.app` from.
