...
1. **`contracts/builder_constrant_contract.md` §D (NEW)** — add Park Phase Discipline as a contract clause. The phase is binding, not optional. Re-seed the constraint registry to pick up the new clause.
