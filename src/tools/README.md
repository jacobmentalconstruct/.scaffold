...
## Standard Tool Contract (per `contracts/BCC.md`)
...
7. Be added to `_docs/reference/TOOLS.md` once registered.
...
6. Register the tool by adding a row to `/_docs/reference/TOOLS.md`.
