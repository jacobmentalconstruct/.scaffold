...
from src.lib.common import now_iso, public_root_labels
...
class ScanOrchestrator:
    ...
    def handle_scan(self, envelope: SidecarEnvelope, state: "SidecarState") -> SidecarEnvelope:
        ...
        scan_id = self._index.begin_scan(project_root=project_root_label, actor_id=actor)
        log.info("scan_orchestrator: begin scan=%s actor=%s root=%s",
                 scan_id, actor, project_root_label)
