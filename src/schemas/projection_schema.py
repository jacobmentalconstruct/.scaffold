...
INTENT_AFFECTS_PROJECTIONS: dict[str, tuple[str, ...]] = {
    "acknowledge_contract": ("contract_status", "current_sidecar_state", "agent_bootstrap"),
    "install": ("current_sidecar_state", "contract_status", "agent_bootstrap"),
    ...
    "close_journal_entry": ("journal_timeline",),
    "archive_journal_entry": ("journal_timeline",),

    "attach_evidence": ("evidence_bag", "human_dashboard"),
    "verify_evidence": ("evidence_bag",),

    "register_constraint": ("contract_status",),
    "register_profile": ("contract_status",),

    "register_tool": ("agent_bootstrap", "current_sidecar_state"),
    "unregister_tool": ("agent_bootstrap", "current_sidecar_state"),
