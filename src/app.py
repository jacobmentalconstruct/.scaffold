...
from src.lib.bcc_constraint_map import ensure_current_bcc_constraint_map
...
def boot(sidecar_root: Path | None = None,
    ...
    # Ensure the derived BCC constraint map exists before projections consume it.
    ensure_current_bcc_constraint_map(state)
    ...
    # zero-context agent entry per ARCHITECTURE.md §12.3 / BCC §10.8.
