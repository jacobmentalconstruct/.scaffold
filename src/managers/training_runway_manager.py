...
class TrainingRunwayManager:
    ...
    def create_sandbox(self, scenario_id: str, *, reset: bool = False) -> dict[str, Any]:
        ...
        contract_path = active_contract_path(Path(self._state.sidecar_root))
        if contract_path.is_file():
            docs_root.joinpath("BCC.md").write_text(
        ...
        return {
            ...
            "contract_path": public_path(docs_root / "BCC.md", self._state.sidecar_root, "."),
    ...
    def run_scenario(
        ...
        *,
        ...
        run_metadata = {
            ...
            "protected_paths": ["_docs/TASK_CARD.md", "_docs/BCC.md"],
